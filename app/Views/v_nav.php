                ...
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    <ul class="nav navbar-nav ">
                        ...
                        <li class="mr-2 d-none d-xl-block">
                            <a href="#home" style="color: black"><i class="feather icon-home" data-toggle="tooltip"
                                    data-placement="top" title="Booking Kamar"></i> Kos</a>
                        </li>
                        <li class="mr-2 d-none d-xl-block">
                            <a href="#rekomendasi" style="color: black"><i class="feather icon-search"
